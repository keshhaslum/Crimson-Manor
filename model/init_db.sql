...
INSERT INTO rooms (room, main_location, description, img) VALUES
  ('Study', 'mansion', 'The room where the victims body was discovered. It is elegantly furnished with antique furniture and lined with bookshelves filled with rare editions.',':books:'),
...
INSERT INTO characters (name, last_name, description, img) VALUES
  ('Emily', 'Green', 'Emily is the victims ambitious assistant, determined to climb the corporate ladder. She has been working for John Parker for years, but rumors suggest she was growing impatient with his management style.', ':red_haired_woman::skin-tone-2:'),
  ('Michale', 'Turner', 'Michael is the victims long-time business rival, always trying to outsmart John in the corporate world. They had a history of bitter competition.', ':man::skin-tone-2:'),
  ('Isabella', 'Martínez', 'Isabella is the victims estranged daughter, who resented her father for prioritizing business over family. They had not spoken for years', ':dancer:');
-- Create clues table
CREATE TABLE clues (
  id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  description TEXT NOT NULL,
...
('A hidden compartment in the conservatory containing a hidden camera', NULL, ':herb::camera:'),
